    ...
    <SpotlightCard className="group/spotlight h-full border-[rgb(var(--accent))]/30">
      <div className="flex flex-col justify-between h-full p-6">
        ...
        <div className="flex items-center gap-4">
          {project.demoUrl && (
            <a href={project.demoUrl} target="_blank" className="flex items-center gap-2 px-4 py-2 rounded-lg font-bold transition-colors bg-[rgb(var(--accent))] hover:bg-[rgb(var(--accent))]/90 text-white dark:text-black">
